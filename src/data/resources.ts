...
export const resourceCategories: ResourceCategory[] = [
  ...
  },
  {
    ...
    intro:
      "These summaries are for orientation only. Scheme rules, eligibility and support levels change. LayaGreenEnergy does not process applications or confirm eligibility.",
    articles: [
      {
        slug: "mse-gift",
        title: "MSE GIFT",
  ...
  },
  {
    ...
    intro:
      "LayaGreenEnergy is the platform. DRIVE is an initiative working on decentralised renewable energy for enterprise productivity. GAME is a separate entrepreneurship organisation active in the wider ecosystem.",
    articles: [
      {
        slug: "what-is-drive",
        title: "What is DRIVE?",
        ...
        body: [
          ...
          { heading: "How it shows up here", text: "The solution categories, opportunity outlines and scheme references on LayaGreenEnergy draw on DRIVE material about DRE-linked livelihoods." },
          { heading: "Relationship to LayaGreenEnergy", text: "DRIVE is a supporting initiative. LayaGreenEnergy is the platform businesses and providers use." },
        ],
      },
      {
        slug: "what-is-game",
        ...
        body: [
          ...
          { heading: "An important distinction", text: "GAME is not presented here as the owner or operator of LayaGreenEnergy. Any specific programme, funding or support should be described only where an official source states it." },
        ],
      },
      {
        ...
        body: [
          ...
          { heading: "On claims", text: "LayaGreenEnergy does not claim that any particular organisation funds any particular enterprise. Specific support is stated only where an official source confirms it." },
        ],
      },
      {
