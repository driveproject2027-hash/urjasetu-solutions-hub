  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>{contactPerson ? `Dear ${contactPerson},` : "Hello,"}</Text>
        ...
        <Section style={statusBox}>
          ...
          {statusMessage ? (
            <Text style={{ ...meta, margin: "8px 0 0" }}>{statusMessage}</Text>
          ) : null}
        </Section>
        ...
        <Text style={paragraph}>
          ...
          <Link href="https://layagreenenergy.com" style={{ color: forest }}>
            layagreenenergy.com
          </Link>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          LayaGreenEnergy — Decentralised Renewable Energy marketplace for Indian MSMEs.
        </Text>
