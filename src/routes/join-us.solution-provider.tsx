...
export const Route = createFileRoute("/join-us/solution-provider")({
  head: () => ({
    meta: [
      { title: "Register as a DRE Solution Provider — LayaGreenEnergy" },
      {
        name: "description",
        content:
      ...
      { property: "og:url", content: "https://layagreenenergy.com/join-us/solution-provider" },
    ...
    links: [{ rel: "canonical", href: "https://layagreenenergy.com/join-us/solution-provider" }],
  }),
